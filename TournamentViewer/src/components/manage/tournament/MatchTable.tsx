                                        ...
                                        {match.songs.map((song, j) => {
                                            ...
                                            if (playerDisabled) {
                                                return <div
                                                    ...
                                                    {controls && <button className={"underline font-red-800 text-xs"}
                                                                         onClick={() => onDeleteStanding(player.id, song.id)}>Reactivate
                                                    </button>}
                                                </div>
                                            }
                                            ...
                                            return (
                                                <div key={j} className="border border-gray-300 p-2">
                                                    <div
                                                        className="text-center  justify-center flex flex-row gap-3 items-center text-gray-600">
                                                        <p
                                                            className={`${
                                                                scoreData?.isFailed
                                                        ...
                                                        {!scoreData && controls && isActive && (
                                                            <>
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="text-xs ml-3 text-red-500"
                                                                    onClick={() => {
                                                                        onAddStandingToMatch(player.id, song.id, -1, 0, true)
                                                                    }}
                                                                >
